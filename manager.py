...
class Manager:
    ...
    def run(self):
        ...
        logging.info(f'updating "{self.weapons_col}" field to identify weapons from "{self.text_col}" field..')
        ...
        logging.info(f'deleting documents by delete query - {self.delete_query}')
        self.client.delete_docs(index_name=self.index_name, query=self.delete_query)

        logging.info('finish to process.')